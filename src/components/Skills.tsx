      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            <div key={categoryIndex} className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <p className="font-semibold text-blue-600">CCNA</p>
                <p className="text-sm text-gray-600">Cisco Networking</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <p className="font-semibold text-indigo-600">Java Fundamentals</p>
                <p className="text-sm text-gray-600">Oracle Academy</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <p className="font-semibold text-slate-600">Cloud Security</p>
                <p className="text-sm text-gray-600">Cisco Academy</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <p className="font-semibold text-blue-600">Full Stack</p>
