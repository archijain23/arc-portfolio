          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="flex space-x-4">
                ...
                <button className="flex items-center space-x-2 px-4 py-2 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-600 hover:text-white transition-colors">
                  <LinkIcon size={16} />
                  <span>Live Demo</span>
                </button>
              </div>
